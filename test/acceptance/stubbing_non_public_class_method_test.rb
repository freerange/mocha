...
class StubbingNonPublicClassMethodTest < Mocha::TestCase
  ...
  def test_should_allow_stubbing_private_class_method
    ...
    assert !stderr.include?("stubbing non-public method: #{klass.mocha_inspect}.private_method")
  end
  ...
  def test_should_allow_stubbing_protected_class_method
    ...
    assert_passed(test_result)
    assert !stderr.include?("stubbing non-public method: #{klass.mocha_inspect}.protected_method")
  end
