...
* `verbose`: Enables a verbose mode which will display matching invocations (including the arguments values passed into the method, any yields and throws that occur, and the return value generated by the expectation) alongside their respective expectations in error messages.
