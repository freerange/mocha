...
Note: Using the latest version of Mocha (0.13.2) with _some_ recent versions of Rails (e.g. 3.2.12, 3.1.10, or 3.0.19), you will see the following Mocha deprecation warning:
