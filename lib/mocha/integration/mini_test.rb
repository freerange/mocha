...
if !MiniTest::Unit::TestCase.ancestors.include?(Mocha::API)
  ...
  require 'mocha/integration/mini_test/version_340'
  ...
  module MiniTest
    class Unit
      class TestCase
        ...
        elsif Gem::Requirement.new('3.4.0').satisfied_by?(mini_test_version)
          include Mocha::Integration::MiniTest::Version340
        else
