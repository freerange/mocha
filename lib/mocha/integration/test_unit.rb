...
if !Test::Unit::TestCase.ancestors.include?(Mocha::API)
  ...
  require 'mocha/integration/test_unit/gem_version_230_to_253'
  ...
  module Test
    module Unit
      class TestCase
        ...
        elsif Gem::Requirement.new('>= 2.3.0', '<= 2.5.3').satisfied_by?(test_unit_version)
          include Mocha::Integration::TestUnit::GemVersion230To253
        else
