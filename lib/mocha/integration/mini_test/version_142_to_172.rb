    ...
    module MiniTest
      module Version142To172
        ...
        module RunMethodPatch
          # rubocop:disable Layout/AlignArray, Lint/RescueException, Style/FormatString, Style/MethodDefParentheses, Style/MultilineIfModifier
          def run runner
            trap 'INFO' do
          ...
          # rubocop:enable Layout/AlignArray, Lint/RescueException, Style/FormatString, Style/MethodDefParentheses, Style/MultilineIfModifier
        end
      end
    end
  end
