            ...
            begin
              ...
              %w{ before_teardown teardown after_teardown }.each do |hook|
                begin
                  ...
                  @passed = false
                  translated_exception = Mocha::Integration::MiniTest.translate(e)
                  runner.record self.class, self.__name__, self._assertions, time, translated_exception
                  result = runner.puke self.class, self.__name__, translated_exception
                end
              end
